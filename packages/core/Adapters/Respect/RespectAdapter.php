...
use SchemableValidator\Adapters\Respect\Rules\BooleanCoercion;
use SchemableValidator\Adapters\Respect\Rules\DateFormat;
use SchemableValidator\Adapters\Respect\Rules\DateTimeFormat;
use SchemableValidator\Adapters\Respect\Rules\FileExtension;
use SchemableValidator\Adapters\Respect\Rules\IntegerCoercion;
use SchemableValidator\Adapters\Respect\Rules\NumberCoercion;
  ...
  public static function bootstrap(): void {
    ...
    \Respect\Validation\Factory::setDefaultInstance(
      (new \Respect\Validation\Factory())
        ->withRuleNamespace('SchemableValidator\\Adapters\\Respect\\Rules')
